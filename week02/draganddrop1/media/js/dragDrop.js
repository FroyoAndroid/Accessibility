(function($)
{
    ...
    var dropElementYPosition=31;
    var iconElementYPosition=40.5;
    var dropElementVGap=6;
    var iconElementVGap=25;
    var zIndexValue=100;
    ...
    function addDragDropElements()
    {
        for(var i=0;i<dragDropJsonObject.droppables[0].drop.length;i++)
        {
            ...
            var attr_3 = {'class':'drag_element','id':'drag_element_'+i,'html':'<span>'+dragDropJsonObject.draggables[0].drag[i].text+'</span>', 'tabIndex': 0};
            ...
            $('#correct_icon_'+i).css({'right':'210px','top':iconElementYPosition});
