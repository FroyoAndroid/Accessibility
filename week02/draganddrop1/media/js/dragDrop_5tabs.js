(function($)
{
    ...
    var noOfAttempts=0;
    //variable to hold the current drag element
    ...
    function addDragDropElements()
    {
        for(var i=0;i<dragDropJsonObject.droppables[0].drop.length;i++)
        {
            ...
            $('#drag_element_'+i).keydown(function(event){
    ...
    function addFeedback()
    {
        ...
        var attr_4 = {'class':'closeBtn','html':'<span></span>', 'tabIndex':0};
