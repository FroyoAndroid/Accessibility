...
(function($){
    jQuery.fn.mbTooltip = function (options){
        return this.each (function () {
            ...
            if (this.options.live)
                $('body').on("mouseover","[tooltiptext]",function(){$(this).mbTooltip(options);});
    ...
    $.fn.extend({
        ...
        buildTooltip: function(cont,options,audiopath){
            ...
            $('#tooltip').prepend("<div class='audio_btn'><audio id='tooltip_audio'><source src='"+audiopath+"' type='audio/mpeg'></source></audio></div><div class='tooltip_desc'></div>");
